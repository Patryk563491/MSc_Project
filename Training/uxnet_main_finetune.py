...
def validation(epoch_iterator_val):
    ...
    with torch.no_grad():
        for step, batch in enumerate(epoch_iterator_val):
            ...
            # IoU Score
            iou = compute_iou(val_output_convert[0], val_labels_convert[0])  # Added IoU computation
            iou_vals.append(iou.item())

            # Recall score
            recall = compute_recall(val_output_convert[0], val_labels_convert[0])  # Added Recall computation
